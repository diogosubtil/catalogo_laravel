                            ...
                            <form action="{{ route('produtos.store') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-xl-3 col-md-6 col-12">
                                            <div class="form-group">
                                                <label for="name" class="mb-3 required">Código Fabricante</label>
                                        ...
                                        <div class="col-xl-3 col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" value="" id="marca_do_produto" name="marca_do_produto" placeholder="Marca do produto" required>
                                            </div>
                                        </div>
                                        <div class="col-xl-3 col-md-6 col-12">
